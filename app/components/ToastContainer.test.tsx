...
describe('ToastContainer', () => {
  ...
  describe('Styling', () => {
    it('applies success color classes for success toast', () => {
      const toasts: Toast[] = [
    ...
    it('applies error color classes for error toast', () => {
    ...
    it('applies warning color classes for warning toast', () => {
      const toasts: Toast[] = [
    ...
    it('applies info color classes for info toast', () => {
